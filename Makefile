...
prog_refine_pascal_nat: refine_pascal_nat/dense_inference.cpp util/Timer.h libDenseCRF.a
	$(CC) -w refine_pascal_nat/dense_inference.cpp -o prog_refine_pascal_nat $(CFLAGS) -L. -lDenseCRF -lmatio -lhdf5 -fopenmp -lpthread -I./util/ -I/usr/local/include -I/usr/include/hdf5/serial/ -L/usr/local/lib/ -L/usr/lib/ -L/usr/lib/x86_64-linux-gnu/ -L/usr/lib/x86_64-linux-gnu/hdf5/serial/
